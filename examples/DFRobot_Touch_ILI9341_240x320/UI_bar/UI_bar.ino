...
void barCallback1(void *obj){
	DFRobot_UI::sObject_t *bar1 = (struct DFRobot_UI::sObject_t *)obj;
    //自动让进度条值每次+1;
   delay(50);
...
void barCallback2(void *obj){
	DFRobot_UI::sObject_t *bar2 = (struct DFRobot_UI::sObject_t *)obj;
    //自动让进度条值每次+1;
    delay(50);
...
void barCallback3(void *obj){
    DFRobot_UI::sObject_t *bar3 = (struct DFRobot_UI::sObject_t *)obj;
    //自动让进度条值每次+1;
    delay(50);
